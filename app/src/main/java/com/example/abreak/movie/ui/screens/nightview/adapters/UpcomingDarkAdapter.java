...
public class UpcomingDarkAdapter extends PagerAdapter {
  private Context context;
  private List<UpComingMovies.Results> results;

  public UpcomingDarkAdapter(Context context, List<UpComingMovies.Results> results) {
