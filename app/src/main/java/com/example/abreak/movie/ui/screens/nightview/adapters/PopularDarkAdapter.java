...
public class PopularDarkAdapter extends PagerAdapter {
  private Context context;
  private List<PouplarMovies.Results> results;

  public PopularDarkAdapter(Context context, List<PouplarMovies.Results> results) {
  ...
  @SuppressLint("SetTextI18n") @SuppressWarnings("ConstantConditions") @NonNull
  @Override
