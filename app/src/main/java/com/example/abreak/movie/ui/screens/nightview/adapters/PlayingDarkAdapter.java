...
public class PlayingDarkAdapter extends PagerAdapter {
  private Context context;
  private List<PlayingMovies.Results> results;

  public PlayingDarkAdapter(Context context, List<PlayingMovies.Results> results) {
  ...
  @SuppressLint("SetTextI18n") @NonNull @Override public Object instantiateItem(@NonNull ViewGroup container, int position) {
